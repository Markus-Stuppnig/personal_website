...
export default function PostsSection({ post }: { post: Post }) {
  return (
    <section
      id="projects"
    ...
    >
      ...
      <div className="flex flex-col h-full mx-[1rem] md:mx-[7rem]">
        ...
        <p className="text-[1.2rem] md:text-[1.7rem] mt-[1rem]">
          ...
          angesetzt, bei dem Franz Puerto und ich eure Meinungen und Ideen hören
          konnten.
        </p>
        <p className="text-[1.2rem] md:text-[1.7rem] mt-[1rem]">
          Direkt darauf haben wir diese beim Abteilungsvorstand, dem Herrn
          Professor Koppensteiner, eingebracht. Aktuell warten wir noch auf den
          Zugriff auf eine Shared Mailbox, sodass wir E-Mails an die gesamte
          Abteilung senden können. Das Protokoll habt ihr hier zum{" "}
          <a
        ...
        <p className="text-[1.2rem] md:text-[1.7rem] mt-[1rem] mb-[3rem] md:mb-[7rem]">
          Ich bin Markus, und habe das vergnügen, als Abteilungssprecher für die
          HIT gewählt worden zu sein. Nachdem der Herr Professor Koppensteiner,
          der Herr Professor Brein, aber auch zahlreiche andere Personen sich
          für mich und mein Auslandssemester eingesetzt haben, möchte ich dem
          TGM etwas zurückgeben. Mit dem Amt als Abteilungssprecher bedanke ich
          mich für die Unterstützung indem ich mich setze für EUER Interesse
          einsetze.
        </p>
      </div>
    </section>
